      ...
      <form onsubmit={handleSubmit} class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-5">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Input label="Nama Lengkap *" iconLeft={UserCog} bind:value={nama_lengkap} placeholder="Contoh: Fulan bin Fulan" />
            <Input label="Nama Panggilan" iconLeft={User} bind:value={nama_panggilan} placeholder="Contoh: Fulan" />
          </div>
